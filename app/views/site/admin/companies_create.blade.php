...
@section('content')
    ...
    <p>At this page you can create a new company.</p>
    <hr />
    @if($errors->has())
    ...
    <div class="form-group @if($errors->has('date_format')) has-error @endif">
        ...
        {{ Form::select('date_format', Company::getDateFormats(), Company::DATE_FORMAT_MMDDYYYY, ['class' => 'form-control', 'rows' => '3']) }}
    </div>
    ...
    <div class="form-group @if($errors->has('email_template')) has-error @endif">
        ...
        {{ Form::textarea('email_template', null, ['class' => 'form-control', 'rows' => '10']) }}
        <span class="help-block">
    ...
    <div class="form-group @if($errors->has('email_reply_to')) has-error @endif">
        ...
        {{ Form::text('email_reply_to', null, ['class' => 'form-control']) }}
