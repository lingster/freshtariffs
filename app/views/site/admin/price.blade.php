...
@section('content')
    ...
    <p>Leave <i>rate</i> field empty if you don't want to suggest destination to specified user.<br />
        If you have many destinations, please use <a href="{{ URL::to('/admin/price/' . $selectedUser->user_id . '/xls') }}" class="a-link">XLS uploading</a>.</p>
...
@section('bottom_scripts')
    ...
    <script type="text/javascript">
        ...
        var alreadyAdded = {};
        var setRateModalError = $('#setRateModalError');
        ...
        function setRatesSubmit(e) {
            ...
            if (!parseFloat(rate)) {
                setRateModalError.text('Rate is not a number.');
