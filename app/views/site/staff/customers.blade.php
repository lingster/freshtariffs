            ...
            @foreach($users as $userInfo)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a data-toggle="tooltip" href="{{ URL::to('/staff/pricelist/' . $userInfo->user_id) }}" alt="Create price list" title="Create price list"><i class="glyphicon glyphicon-list-alt"></i></a>
